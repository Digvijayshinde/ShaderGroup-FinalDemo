...
OceanCamera::OceanCamera()
{
	...
	anglecurve.Set(0, -2.5f, -0.5f);
	positioncurve.Set(0, 1.8f, 0);
	//positioncurve.Set(0, -2.5f, 0);
...
void OceanCamera::FitToBox(const Math::AABox& box)
{
...
void OceanCamera::GetEyePosition(Math::Vector3& out)
{
	out = smoothedposition;
}

void OceanCamera::GetOrientation(Math::Vector3& out)
{
	out = smoothedangles;
}

void OceanCamera::GetViewMatrix(Math::Matrix& out)
{
	out = view;
}

void OceanCamera::GetViewVectors(Math::Vector3& forward, Math::Vector3& right, Math::Vector3& up)
{
...
void OceanCamera::GetProjectionMatrix(Math::Matrix& out)
{
	Math::MatrixPerspectiveFovRH(out, fov, aspect, nearplane, farplane);
}

void OceanCamera::SetEyePosition(float x, float y, float z)
{
...
void OceanCamera::SetOrientation(float yaw, float pitch, float roll)
{
...
void OceanCamera::Update(float dt)
{
...
void OceanCamera::Animate(float alpha)
{
	Math::Matrix yaw, pitch;
...
void OceanCamera::MoveCameraForward(void)
{
	//code
	state |= CameraStateForward;
}

void OceanCamera::MoveCameraBackward(void)
{
	//code
	state |= CameraStateBackward;
}

void OceanCamera::MoveCameraLeft(void)
{
	//code
	state |= CameraStateLeft;
}

void OceanCamera::MoveCameraRight(void)
{
	//code
	state |= CameraStateRight;
}

void OceanCamera::MoveCameraForwardR(void)
{
	//code
	state &= (~CameraStateForward);
}

void OceanCamera::MoveCameraBackwardR(void)
{
	//code
	state &= (~CameraStateBackward);
}

void OceanCamera::MoveCameraLeftR(void)
{
	//code
	state &= (~CameraStateLeft);
}

void OceanCamera::MoveCameraRightR(void)
{
	//code
	state &= (~CameraStateRight);
}
...
//
//void OceanCamera::OnMouseMove(int16_t dx, int16_t dy)
//{
...
//}
//
//void OceanCamera::OnMouseDown(MouseButton button)
//{
//	if (button == MouseButtonLeft)
//		state |= CameraStateRotating;
//}
//
//void OceanCamera::OnMouseUp(MouseButton button)
//{
//	if (button == MouseButtonLeft)
//		state &= (~CameraStateRotating);
//}
