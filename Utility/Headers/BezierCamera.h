...
public:
    ...
    void initialize(void)
    {
        ...
        colorShader.initializeColorShaderProgram();
        ...
        glBindVertexArray(vao_line);
        {
            ...
            // Color
            {
                glVertexAttrib4f(SHADER_ATTRIBUTE_COLOR, 1.0f, 0.0f, 0.0f, 1.0f);
            }
        }
        glBindVertexArray(0);
    }
    ...
    void updateCameraVectors()
    {
        ...
        if (handlePerspective && perspectivePoints.size() > 0)
        {
            ...
            prespectiveProjectionMatrix = vmath::perspective(45.0f + degToRad(fov), (GLfloat)gWinWidth / (GLfloat)gWinHeight, 0.1f, 10000000.0f);
        }
    ...
    void displayBezierCurve()
    {
        ...
        // pushMatrix(modelMatrix);
        {
            ...
            colorShader.displayColorShader(mat4::identity(), getViewMatrix(), vec3(1.0f, 0.0f, 0.0f));
            glBindVertexArray(vao_line);
            glVertexAttrib4f(SHADER_ATTRIBUTE_COLOR, 1.0, 0.0, 0.0, 1.0);
